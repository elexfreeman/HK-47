...
3. **ЗАВЕРШЕНИЕ**:
   ...
   - **ВАЖНО**: В этом сценарии НЕ вызывай \`commitToMemoryCore\` самостоятельно. Сохранение данных выполняется внешним протокол при обнаружении стоп-фразы. Твоя задача — только подтвердить запись голосом.
...
# VII. **ФИНАЛЬНЫЙ СИСТЕМНЫЙ ПРОТОКОЛ**
